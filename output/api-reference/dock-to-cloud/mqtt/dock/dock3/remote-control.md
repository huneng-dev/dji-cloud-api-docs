...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E5%96%8A%E8%AF%9D%E5%99%A8%E2%80%94%E9%9F%B3%E9%A2%91%E6%92%AD%E6%94%BE%E8%BF%9B%E5%BA%A6) 喊话器—音频播放进度
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/up
**Direction:** up
...
| md5  | 验证  | string  |   |   |  
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#psdk%E2%80%94%E7%8A%B6%E6%80%81%E4%B8%8A%E6%8A%A5) PSDK—状态上报
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/up
**Direction:** up
...
| »index  | index  | int  |   |   |  
| »value  | value  | int  |   |   |  
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#psdk%E2%80%94ui%E8%B5%84%E6%BA%90%E5%8C%85%E4%B8%8A%E4%BC%A0) PSDK—UI资源包上传
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/up
**Direction:** up
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E9%A3%9E%E8%A1%8C%E5%99%A8%E7%8A%B6%E6%80%81%E4%BF%A1%E6%81%AF%E4%B8%8A%E6%8A%A5) 飞行器状态信息上报
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/up
**Direction:** up
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E7%9B%B8%E6%9C%BA%E7%8A%B6%E6%80%81%E4%B8%8A%E6%8A%A5) 相机状态上报
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E6%91%84%E5%83%8F%E5%A4%B4osd-%E6%8E%A8%E9%80%81) 摄像头osd 推送
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#ai%E7%8A%B6%E6%80%81%E4%B8%8A%E6%8A%A5) AI状态上报
...
| »state_reason  | 状态原因  | enum_int  | {"0":"正常","1":"距离目标过近","2":"距离目标过远","3":"到达限低","4":"到达限高","5":"到达限远","6":"接近限飞区","7":"云台到达限位","8":"飞机偏航达到环绕模式最大限制","9":"障碍物距离过近","10":"定位源切换(GPS→RTK)","11":"定位源切换(RTK→GPS)","12":"避障失效","13":"到达变焦范围限制","14":"跟踪目标丢失","15":"GPS信号弱",  
**注意：以下状态原因，会退出AI跟随**  
160":"正常退出","161":"未适配负载","162":"不支持相机模式","163":"非法命令","164":"定位失败","165":"飞机未起飞","166":"飞行模式错误","167":"当前模式不可用(返航/降落/姿态)","168":"丢失遥控/图传信号"}  | 当前状态或退出原因说明。  |  
...
```
#  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#service) Service
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E5%A4%9C%E6%99%AF%E6%A8%A1%E5%BC%8F%E8%AE%BE%E7%BD%AE) 夜景模式设置
seq是递增的序号，保证指令顺序执行，与data同级
...
| Column  | Name  | Type  | constraint  | Description  |  
| --- | --- | --- | --- | --- |  
| payload_index  | 相机枚举  | text  | {"length":""}  | 相机枚举值。非标准的 device_mode_key，格式为 {type-subtype-gimbalindex}，可以参考[产品支持](  
建议使用M4D（98-0-0）和M4TD（99-0-0））  |  
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E9%99%8D%E5%99%AA%E7%AD%89%E7%BA%A7%E8%AE%BE%E7%BD%AE) 降噪等级设置
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/down
**Direction:** down
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%E9%BB%91%E7%99%BD%E5%A4%9C%E8%A7%86%E4%BD%BF%E8%83%BD) 黑白夜视使能
seq是递增的序号，保证指令顺序执行，与data同级
**Topic:** thing/product/_{gateway_sn}_ /drc/down
**Direction:** down
...
```
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock3/remote-control.html#%