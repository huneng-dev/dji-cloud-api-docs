...
| »payload_index  | 负载编号  | text  |   | 负载索引，格式为 _{type-subtype-gimbalindex}_  | r  | 1  |  
...
| _{type-subtype-gimbalindex}_  | 负载编号  | struct  |   | 与字段 payload_index 数值一致  | r  | 0  |  
...
| »payload_index  | 负载索引，格式为 _{type-subtype-gimbalindex}_  | text  |   |   | r  | 1  |  
