...
<!-- path: api-reference/dock-to-cloud/mqtt/aircraft/m3d-properties -->

###  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/aircraft/m3d-properties.html#%E8%AE%BE%E5%A4%87%E5%B1%9E%E6%80%A7%E5%88%97%E8%A1%A8) 设备属性列表
  * pushMode：
...
| »payload_index  | 负载索引，格式为 _{type-subtype-gimbalindex}_  | text  |   |   |   | 0  |  
...
| »»value  | 控件值  | int  | {}  |   | r  | 1  |  
| remaining_power_for_return_home  | 返航预留电量  | int  | {"max":100,"min":0}  |    
**注意：预留返航电量设置过低可能导致飞机没有足够电量完成返航。对于 DJI Dock 2，我们建议将该值设置在 25% ~ 50% 范围内以提供更安全的返航电量预留。**  | rw  | 1  |