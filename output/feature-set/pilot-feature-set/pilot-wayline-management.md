...
我们提供了[航线文件格式规范open in new window](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dji-wpml/overview.html)。用户遵照规范编写航线文件，可以明显降低开发门槛。
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/feature-set/pilot-feature-set/pilot-wayline-management.html#%E4%BA%A4%E4%BA%92%E6%97%B6%E5%BA%8F%E5%9B%BE) 交互时序图
DJI Pilot 2 WebviewDJI DJI Pilot 2Cloud ServerObject Storage需先设置workspaceId, 加载api,mission模块下载航线文件上传航线文件收藏或删除收藏 航线文件登录第三方云平台加载api模块加载mission模块连接DJI Pilot 2首次上线，请求航线列表【获取航线列表】应答点击下载航线文件【请求航线文件下载地址】接口应答拉取航线文件应答创建新航线，编辑并保存，手动点击上传【请求获取上传临时凭证sts】接口应答上传航线文件应答【航线文件上传结果回调推送】接口应答对于高频使用的航线文件，点击收藏调用【创建航线收藏】接口应答点击取消收藏某个航线文件调用【删除航线收藏】接口应答DJI Pilot 2 WebviewDJI DJI Pilot 2Cloud ServerObject Storage
##  [#](https://developer.dji.com/doc/cloud-api-tutorial/cn/feature-set/pilot-feature-set/pilot-wayline-management.html#%E6%8E%A5%E5%8F%A3%E8%AF%A6%E7%BB%86%E5%AE%9E%E7%8E%B0) 接口详细实现
...
在使用航线模块功能之前，需要预先在H5页面中通过JSBridge设置好工作空间信息（workspaceId），配置好api模块，然后加载DJI Pilot 2的mission模块。开发者可以考虑在上下线登录阶段直接添加加载mission模块的接口。
  * [航线管理（HTTPS）open in new window](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/pilot-to-cloud/https/waypoint-management/obtain-waypointfile-list.html)
    * 获取上传临时凭证  
